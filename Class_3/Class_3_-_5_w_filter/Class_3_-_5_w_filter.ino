...
AudioSynthWaveform       waveform5;      //xy=248.3333333333333,369.99999999999994
AudioMixer4              mixer1;         //xy=271.1666488647461,192.8333396911621
AudioFilterStateVariable filter1;        //xy=405.8332824707031,238.33331489562988
AudioOutputI2S           i2s1;           //xy=543.3333282470703,188.50000095367432
AudioConnection          patchCord1(waveform2, 0, mixer1, 1);
AudioConnection          patchCord2(waveform3, 0, mixer1, 2);
AudioConnection          patchCord3(waveform1, 0, mixer1, 0);
AudioConnection          patchCord4(waveform4, 0, mixer1, 3);
AudioConnection          patchCord5(waveform5, 0, filter1, 1);
...
void setup() {
  ...
  waveform3.begin(1, 220.0, WAVEFORM_SQUARE);
  waveform4.begin(1, 440.0, WAVEFORM_SQUARE);
  waveform5.begin(.5, 440.0, WAVEFORM_SINE);
...
void loop() {
  ...
  if (cm - prev[1] > 20) {
    ...
    freq[6] = (analogRead(A2) / 4095.0) * 5000.0 ;
