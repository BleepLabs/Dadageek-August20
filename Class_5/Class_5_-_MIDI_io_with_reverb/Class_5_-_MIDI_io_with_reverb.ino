...
AudioSynthWaveform       waveform[12];      //xy=286.8238525390625,131
AudioSynthWaveform       waveform1;      //xy=299.8238525390625,75
AudioEffectEnvelope      envelope1;      //xy=439.8238525390625,46
AudioEffectEnvelope      envelope2;      //xy=473.8238525390625,115
AudioEffectChorus        chorus1;        //xy=618.8238525390625,231
AudioMixer4              mixer1;         //xy=693.8238525390625,113
AudioEffectFreeverb      freeverb1;      //xy=791,233
AudioOutputI2S           i2s1;           //xy=967.8238525390625,343
AudioAmplifier           amp1;           //xy=974.8238525390625,287
AudioMixer4              mixer2;         //xy=980.8238525390625,124
...
AudioConnection          patchCord5(chorus1, freeverb1);
AudioConnection          patchCord6(mixer1, chorus1);
...
AudioConnection          patchCord12(mixer2, amp1);
AudioControlSGTL5000     sgtl5000_1;     //xy=628.8238525390625,374
...
void setup() {
  ...
  mixer1.gain(0, .4);
  mixer1.gain(1, .4);
  mixer1.gain(2, 0); //chorus feedback
  mixer1.gain(3, 0);
